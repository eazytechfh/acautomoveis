...
import { Trash2, Shield, Clock, XCircle, Briefcase, Users, TrendingUp, Lock } from "lucide-react"
...
export function MembersManagement({ members, currentUser, onMembersUpdate }: MembersManagementProps) {
  ...
  const handleCargoChange = async (memberId: number, newCargo: "gestor" | "sdr" | "vendedor") => {
    if (!canManage) {
        ...
        {members.map((member) => (
          <div key={member.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex flex-col gap-2 ml-2">
              ...
              <Select
                value={member.cargo}
                onValueChange={(value) => handleCargoChange(member.id, value as "gestor" | "sdr" | "vendedor")}
