  ...
  try {
    ...
    if (newStage === "em_negociacao") {
      try {
        ...
        // Check if agendamento already exists
        ...
        } else if (existingAgendamentos?.length) {
...
export async function generateResumoComercial(lead: Lead): Promise<boolean> {
  try {
    ...
    const webhookUrl = "https://eazytech-n8n.gsl3ku.easypanel.host/webhook/e9e7cf0b-84f5-4b67-9498-c5f8a32ab102"
